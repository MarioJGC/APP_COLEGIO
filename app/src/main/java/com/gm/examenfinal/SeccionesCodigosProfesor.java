...
import pojo.QrAdapter;
import pojo.Seccion;
import util.Util;

public class SeccionesCodigosProfesor extends AppCompatActivity implements Response.Listener<JSONObject>,
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_secciones_codigos_profesor);
        ...
        recyclerSecciones =findViewById(R.id.recyclerSecciones);
    ...
    public void onResponse(JSONObject response) {
        ...
        try {
            ...
            QrAdapter qrAdapter = new QrAdapter(listaSecciones);
            recyclerSecciones.setAdapter(qrAdapter);
        }catch (Exception e){
            e.printStackTrace();
