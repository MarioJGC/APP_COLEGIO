...
import com.gm.examenfinal.CodigoAsistencia;
import com.gm.examenfinal.R;

import java.util.List;

public class QrAdapter extends RecyclerView.Adapter<QrAdapter.QrHolder>{

    List<Seccion> listaSeccion;

    public QrAdapter(List<Seccion> listaSeccion) {
    ...
    public class QrHolder extends RecyclerView.ViewHolder implements View.OnClickListener {
        ...
        public void onClick(View v) {
            ...
            if (position != RecyclerView.NO_POSITION) {
                ...
                Intent i = new Intent(itemView.getContext(), CodigoAsistencia.class);
